    ...
    def _mount_static_files(self):
        ...
        class AuthMiddleware(BaseHTTPMiddleware):
            async def dispatch(self, request, call_next):
                if request.url.path in ["/login.html", "/verification-success.html", "/forgot-password.html", "/reset-password.html", "/reset-success.html", "/session-expired.html", "/register.html", "/auth/reset-password", "/auth/forgot-password", "/auth/verify", "/auth/register", "/auth/token", "/auth/checksession"]:
